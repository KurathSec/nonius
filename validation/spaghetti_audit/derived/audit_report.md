...
--------------------------------------------------------------------------------------------------------------------------------------
    ...
    2     690 predicted            0.3270           0.0965           0.0001           0.0952  0.0000   0.4812   0.5188  0.2305  0.0616
...
At the item level: 796 of 1500 (53.1%) are answered perfectly by all four systems, 213 (14.2%) are failed by all four, and 491 (32.7%) discriminate. The gap between the top two systems is 0.0700.
